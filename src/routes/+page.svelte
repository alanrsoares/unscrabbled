...
<section class="flex flex-col gap-4 md:gap-8 flex-1 relative">
	...
	{#if $wordsQuery.isFetched}
		<article
			class="card -mx-4 md:m-auto bg-gray-900 w-screen md:w-full flex-1 relative animate-appear-1 shadow-lg md:shadow-xl p-2"
		>
			<div class="card-body overflow-y-scroll snap-proximity max-h-[49vh] md:max-h-[60vh] p-4">
